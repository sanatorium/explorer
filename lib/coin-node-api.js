// request from public-api exposed in app.js

var rpccoincli = require('./rpc-coin-cli.js');
...
var specialcommands = [
  ...
  "get_masternodelist_activeseconds",
  "get_masternodelist_lastseen",
  "get_masternodelist_status",
  "get_masternodelist_pubkey",
  "getmasternodecount",
...
module.exports = function(){
  ...
  function express_app(){
    ...
    app.get('*', hasAccess, function(req, res){
      ...
      if(method == 'sendmany'
      || method == "getmasternodelist_addr"
      || method == "getmasternodelist_full"
      || method == "getmasternodelist_info"
      || method == "get_masternodelist_activeseconds"
      || method == "get_masternodelist_lastseen"
      || method == "get_masternodelist_status"
      || method == "get_masternodelist_pubkey"
    ...
    function specialApiCase(method_name){
      ...
      if(method_name == 'getmasternodelist_addr'){
        method_name = 'masternodelist';
        params.push('addr');
      }

      if(method_name == 'getmasternodelist_full'){
        method_name = 'masternodelist';
        params.push('full');
      }

      if(method_name == 'getmasternodelist_info'){
        method_name = 'masternodelist';
        params.push('info');
      }

      if(method_name == 'getmasternodelist_activeseconds'){
        method_name = 'masternodelist';
        params.push('activeseconds');
      }

      if(method_name == 'getmasternodelist_lastseen'){
        method_name = 'masternodelist';
        params.push('lastseen');
      }

      if(method_name == 'getmasternodelist_status'){
        method_name = 'masternodelist';
        params.push('status');
      }

      if(method_name == 'getmasternodelist_pubkey'){
        method_name = 'masternodelist';
        params.push('pubkey');
      }
  ...
  function setWalletDetails(details){
    if('undefined' == typeof details.rpc){
      client = new rpccoincli.Client(details);
    }
    else{
      client = details;
    }

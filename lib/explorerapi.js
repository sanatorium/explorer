// expose public api commands -> ie: http://localhost:3333/api/get_masternodelist_full -> request via app.js to ./lib/coin-node-api.js
...
module.exports = {
  ...
  get_masternodelist_addr: function(cb) {
    var uri = base_url + 'getmasternodelist_addr';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

  get_masternodelist_full: function(cb) {
    var uri = base_url + 'getmasternodelist_full';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

  get_masternodelist_info: function(cb) {
    var uri = base_url + 'getmasternodelist_info';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

  get_masternodelist_activeseconds: function(cb) {
    var uri = base_url + 'getmasternodelist_activeseconds';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

  get_masternodelist_lastseen: function(cb) {
    var uri = base_url + 'getmasternodelist_lastseen';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

  get_masternodelist_status: function(cb) {
    var uri = base_url + 'getmasternodelist_status';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

  get_masternodelist_pubkey: function(cb) {
    var uri = base_url + 'getmasternodelist_pubkey';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

...
exports.menu_masternodes = "Masternodes", //// modmod
...
exports.mn_title = "Masternodes", //// modmod unused
exports.mn_ip = "IP", //// modmod
exports.mn_message = "Message",
exports.mn_protocol = "Protocol",
exports.mn_lastseen = "Last Seen",
exports.mn_activeseconds = "Active Seconds",
exports.mn_portscannerstatus = "Port Check",
...
exports.api_getmininginfo = "Returns the current mining information such as network hashrate (MH/s), stake weight and block height.", //// modmod
...
exports.api_getmasternodelist_addr = "Returns the complete master node list (addr).",
exports.api_getmasternodelist_full = "Returns the complete master node list (full).",
exports.api_getmasternodelist_info = "Returns the complete master node list (info).",
exports.api_getmasternodelist_activeseconds = "Returns the complete master node list (activeseconds).",
exports.api_getmasternodelist_lastseen = "Returns the complete master node list (lastseen).",
exports.api_getmasternodelist_status = "Returns the complete master node list (status).",
exports.api_getmasternodelist_pubkey = "Returns the complete master node list (pubkey).",
...
exports.api_getmasternodes = 'Returns a list of the masternodes currently detected on the network.', //// modmod
